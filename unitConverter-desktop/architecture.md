...
For Android APK and iOS builds targeting phone and tablet devices, see the mobile project:
- [Mobile README - Building](../unitConverter-mobile/README.md#building)
- [Mobile Architecture - Android/iOS Builds](../unitConverter-mobile/architecture.md#android-apk-build-briefcase)
